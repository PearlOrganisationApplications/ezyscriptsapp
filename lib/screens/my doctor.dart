          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                String doctorName = ''; // Get the doctor name from the TextFormField
                String specialization = ''; // Get the specialization from the TextFormField
                Doctor newDoctor = Doctor(name: doctorName, specialization: specialization);

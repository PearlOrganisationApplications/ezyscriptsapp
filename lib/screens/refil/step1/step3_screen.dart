...
class _Step3State extends State<Step3> {
      ...
      child: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 6,),
            Text('Card color(Optional)',style: TextStyle(color: Colors.black,fontWeight: FontWeight.w600),),
  ...
  Future<void> requestScript() async {
    try {
      print(token);
      print(selectedHealthConditions);
      ...
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          "have_allergies": isAlergies,
          "allergy_desc": isAlergies ? null : specifyAlergiesController.text,
          "have_medications": isTakeMed,
          "medication_desc": isTakeMed ? null : specifyMediationsController.text,
          "have_medic_history": isMedicalHistory,
          "medic_desc": isMedicalHistory ? null : medicalHistoryController.text,
          "have_chronic": isChronoicConditions,
          "chronic_desc": isChronoicConditions ? null : selectedHealthConditions.toList(),
        }),
      );

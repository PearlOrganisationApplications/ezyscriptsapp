...
class RequestConsulationDescription extends StatefulWidget {
  ...
  RequestConsulationDescription({required this.text, required this.price});

  @override
  State<RequestConsulationDescription> createState() => _RequestConsulationDescriptionState();
}

class _RequestConsulationDescriptionState extends State<RequestConsulationDescription> {
        ...
        children: [
          Column(
            children: [
             ...
             widget.text=="Weight Management" ?questionsList():Container(),
              CustomButton(
                text: 'Add To Card',
                onPressed: () {
                  requestConsulation();
  ...
  Widget questionsList() {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('CONSULTATION REQUEST DETAILS',style: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.w500),),
          Text('What phone number would you like the doctor to call?*',style: TextStyle(color: Colors.black,fontSize: 17,fontWeight: FontWeight.w500),),
          CustomTextFormField(labelText: 'Mobile Number', controller: mobileController),
          Text('What is the reason for your request? *',style: TextStyle(color: Colors.black,fontSize: 17,fontWeight: FontWeight.w500),),
          CustomTextFormField(labelText: 'reason', controller: reasonRequestController),

          Text('Please enter your height (in cm).',style: TextStyle(color: Colors.black,fontSize: 17,fontWeight: FontWeight.w500),),
          CustomTextFormField(labelText: 'Height', controller: heightController),
          Text('Please enter your weight (in kg).',style: TextStyle(color: Colors.black,fontSize: 17,fontWeight: FontWeight.w500),),
          CustomTextFormField(labelText: 'Weight', controller: weightController),
          ...
          Container(
            child: ListView.separated(
                ...
                itemCount: weightQuestions.length),
          ),
        ],
      ),
    );

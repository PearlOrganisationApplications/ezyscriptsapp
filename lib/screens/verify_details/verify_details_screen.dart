    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          CustomTextFormField(labelText: 'Name', controller: firstName, validator: (value) => value?.isEmpty ?? true
              ? "Name is required"
              : null,),
          SizedBox(height: 10,),
          Text('Last Name*', style: TextStyle(
              color: Colors.black, fontWeight: FontWeight.w600),),
          CustomTextFormField(labelText: 'Last Name', controller: latsName, validator: (value) => value?.isEmpty ?? true
              ? "last name is required"
              : null,),
          SizedBox(height: 10,),
          Text('Email*', style: TextStyle(
              color: Colors.black, fontWeight: FontWeight.w600),),
          CustomTextFormField(labelText: 'email', controller: email, validator: (value) => value?.isEmpty ?? true
              ? "email is required"
              : null,),
          SizedBox(height: 10,),
          ...
          Text('islander*', style: TextStyle(
              color: Colors.black, fontWeight: FontWeight.w600),),
          CustomTextFormField(labelText: 'islander', controller: islander, validator: (value) => value?.isEmpty ?? true
              ? "islander is required"
              : null,),
          SizedBox(height: 10,),

          Text('Apartment*', style: TextStyle(
              color: Colors.black, fontWeight: FontWeight.w600),),
          CustomTextFormField(labelText: 'apartment', controller: apartment, validator: (value) => value?.isEmpty ?? true
              ? "Apartment is required"
              : null,),
          SizedBox(height: 10,),
          Text('Street*', style: TextStyle(
              color: Colors.black, fontWeight: FontWeight.w600),),
          CustomTextFormField(labelText: 'street', controller: street, validator: (value) => value?.isEmpty ?? true
              ? "Street is required"
              : null,),
          ...
          CustomTextFormField(labelText: 'state', controller: state, validator: (value) => value?.isEmpty ?? true
              ? "state is required"
              : null,),
          SizedBox(height: 10,),
          ...
          Text('PostCode*', style: TextStyle(
              color: Colors.black, fontWeight: FontWeight.w600),),
          CustomTextFormField(labelText: 'postCode', controller: postCode, validator: (value) => value?.isEmpty ?? true
...
final email = TextEditingController(text: userDetails?.email);
